...
<tbody>
  ...
  <p align="center"> <img src="sources/images/tune_llama2_7b_ModelLink_DeepSpeed_compare.png" height="300px" width="500px"> </p>
        </th>
        <th rowspan="1">Qwen-7b模型与<a href="https://github.com/hiyouga/LLaMA-Factory/tree/main">DeepSpeed</a>微调4个epoch后的loss对比图

<p align="center"> <img src="sources/images/tune_qwen_7b_ModelLink_DeepSpeed_compare.png" height="300px" width="500px"> </p>
        </th>
    </tr>
</tbody>
</table>
...
| CodeLLaMA-34B | HumanEval                                    | 48.78%    | [48.8%](https://paperswithcode.com/sota/code-generation-on-humaneval) | Gemma-2B         | MMLU      | 39.6%     | --                                                                                 |
...
| LLaMA3.1-8B   | MMLU         | 65.26%    | --                                                                    | LLaMA3.1-70B     | MMLU      | 81.8%     | --                                                                                 |
