...
enum SelfAttentionCrossEnAdapterEnTensorId : int {
...
void BmmReshapeFunc(const atb::Dims &oldShape, atb::Dims &newShape)
{
...
atb::Status SelfAttentionCrossEnAdapter(const SelfAttentionCrossParam &param, atb::Operation **operation)
{
    ...
    opGraph.name = "SelfAttentionCrossEnAdapter";
    ...
    int64_t nodeId = 0;
    auto &getpastKNode = opGraph.nodes.at(nodeId++);
    auto &getpastVNode = opGraph.nodes.at(nodeId++);
    ...
    atb::infer::TransposeParam oriTranspose1Param = { { 0, 1, 2, 3 } };
    CREATE_OPERATION(oriTranspose1Param, &getpastKNode.operation);
    getpastKNode.inTensorIds = { IN_XK };
    getpastKNode.outTensorIds = { OUT_PRESENT_KEY };

    CREATE_OPERATION(oriTranspose1Param, &getpastVNode.operation);
    getpastVNode.inTensorIds = { IN_XV };
    getpastVNode.outTensorIds = { OUT_PRESENT_VALUE };
    ...
    bmmAQKNode.inTensorReshapeFuncs = { &BmmReshapeFunc, &BmmReshapeFunc };
