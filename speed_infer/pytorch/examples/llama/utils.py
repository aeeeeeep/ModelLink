...
class GenerationMixin:
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        pre_next_token_time = pre_total_token_time / (forward_count - 1)
        ...
        forward_next_token_time = forward_total_token_time / (forward_count - 1)
        ...
        post_next_token_time_post = post_total_token_time / (forward_count - 1)
        ...
        if return_dict_in_generate:
            ...
            return input_ids,pre_first_token_time, pre_next_token_time, forward_first_token_time, forward_next_token_time, post_first_token_time, post_next_token_time_post
