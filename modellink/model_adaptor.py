...
from .core import (vocab_embedding_wrapper, initialize_model_parallel_decorator,
                   ...
                   RotaryEmbedding_forward_wrapper, apply_rotary_pos_emb_wrapper)
...
def exe_adaptor():
    ...
    megatron.core.models.common.embeddings.rotary_pos_embedding.RotaryEmbedding.forward = RotaryEmbedding_forward_wrapper(
        megatron.core.models.common.embeddings.rotary_pos_embedding.RotaryEmbedding.forward)
    megatron.core.transformer.attention.apply_rotary_pos_emb = apply_rotary_pos_emb_wrapper(
        megatron.core.transformer.attention.apply_rotary_pos_emb)
    megatron.model.transformer.apply_rotary_pos_emb = apply_rotary_pos_emb_wrapper(
        megatron.model.transformer.apply_rotary_pos_emb)
