...
def add_arguments(parser):
    group = parser.add_argument_group(title='Qwen-2 HF loader.')
...
def _load_checkpoint(queue, args):
    ...
    margs.use_mcore_models = args.use_mcore_models
    ...
    # bloom
    if hasattr(model.embedding.word_embeddings, 'norm'):
        message["word embeddings norm_w"] = model.embedding.word_embeddings.norm.weight.data
        message["word embeddings norm_b"] = model.embedding.word_embeddings.norm.bias.data
