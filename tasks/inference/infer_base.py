...
def task4(args, model, tokenizer=None, system_template="", dialog_template="{instruction}"):
...
def task5(args, model, tokenizer=None, system_template="", dialog_template="{instruction}"):
...
def task6(args, model, tokenizer=None, system_template="", dialog_template="{instruction}"):
