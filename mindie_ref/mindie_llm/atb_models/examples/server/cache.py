...
class ModelConfig:
    def __init__(self, num_heads, num_kv_heads, head_size, num_layers, device, dtype, soc_info):
...
class CacheManager:
    def __init__(self, cache_config, model_config):
        ...
        if self.soc_info.need_nz:
            ...
            print(f'===================self.kv_cache[0][0].shape: {self.kv_cache[0][0].shape}')
            print(f'===================self.kv_cache[0][1].shape: {self.kv_cache[0][1].shape}')
