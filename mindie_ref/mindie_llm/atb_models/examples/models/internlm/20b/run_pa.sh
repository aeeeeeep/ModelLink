...
debug_cmd="ATB_LOG_LEVEL=INFO ATB_LOG_TO_FILE=1 ASDOPS_LOG_TO_STDOUT=1 ASDOPS_LOG_TO_FILE=1 ASDOPS_LOG_LEVEL=INFO ATB_STREAM_SYNC_EVERY_KERNEL_ENABLE=1"
base_cmd="INF_NAN_MODE_ENABLE=0 torchrun --nproc_per_node $TP_WORLD_SIZE --master_port $MASTER_PORT -m examples.run_pa --model_path $model_path"
