...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def prepare_inputs_for_ascend(self, batch_size, seq_length, input_ids, inputs_embeds, position_ids, attention_mask, past_key_values):
    ...
    def init_ascend_operations(self):
        ...
        self.acl_encoder_operation = torch.classes.ModelTorch.ModelTorch("minigpt4_vicuna_7b_FlashAttentionEncoderModel")
    ...
    def forward(
        ...
        if past_key_values is None:
            self.token_num = inputs_embeds.shape[1]
        ...
        # set ascend inputs
        self.prepare_inputs_for_ascend(batch_size, seq_length, input_ids, inputs_embeds, position_ids, attention_mask, past_key_values)
