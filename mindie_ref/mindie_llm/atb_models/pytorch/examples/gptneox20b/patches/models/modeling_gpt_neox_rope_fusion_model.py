...
class GPTNeoXModel(GPTNeoXPreTrainedModel):
    ...
    def init_ascend_operations(self, config: GPTNeoXConfig):
        ...
        self.acl_encoder_operation = torch.classes.ModelTorch.ModelTorch("gptneox_20b_fa_kvcache_rope_model")
        self.acl_decoder_operation = torch.classes.ModelTorch.ModelTorch("gptneox_20b_fa_kvcache_rope_model")
