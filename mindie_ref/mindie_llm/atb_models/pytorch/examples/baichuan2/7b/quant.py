...
tokenizer = AutoTokenizer.from_pretrained(pretrained_model_name_or_path='/data/models/baichuan2/7b/Baichuan2-7B-Chat',
                                          trust_remote_code=True, use_fast=False, padding_side='left')
model = AutoModelForCausalLM.from_pretrained(pretrained_model_name_or_path='/data/models/baichuan2/7b/Baichuan2-7B-Chat',
                                             torch_dtype=torch.float32, trust_remote_code=True).cpu()
