...
def load_model(args):
    ...
    if len(args.device) == 1:
        torch_npu.npu.set_device(args.device[0])
        tokenizer = BloomTokenizerFast.from_pretrained(args.model_path, use_fast=False)
        ...
        raise Exception("Error! too many device!")
