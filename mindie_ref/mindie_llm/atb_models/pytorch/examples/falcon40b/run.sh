...
cp modeling_falcon_patch.py $TRANSFORMER_PACKAGE_PATH/modeling_falcon.py

if [ $run_mode == "cut" ]; then
    cp modeling_falcon_patch_for_cut.py $TRANSFORMER_PACKAGE_PATH/modeling_falcon.py
