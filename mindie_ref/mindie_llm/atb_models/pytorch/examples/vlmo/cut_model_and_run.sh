#!/bin/bash
input_dir="./vlmo/vlmo_base_patch16_480_vqa.pt"
output_dir="./vlmo/part_model"
...
start_cmd="torchrun --nproc_per_node 2 --master_port 20001 cut_ascend_vqa.py with "task_finetune_vqa_base_image480"  test_only=True"
run_cmd="${start_cmd}"
