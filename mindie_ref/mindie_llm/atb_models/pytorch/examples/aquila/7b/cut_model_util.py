...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_path",
        default="/pytorch/examples/Aquila/7b/model",
        help="Location of Model weights, which contains model folders",
    )
    parser.add_argument(
        "--output_path",
        default='/pytorch/examples/Aquila/7b/part_model',
    ...
    # step 4: cut weight
    state_dict_list = cut_weights(model, args.world_size, args.cut_c_attn_keys, args.cut_row_keys, args.cut_col_keys)
    ...
    for i in range(args.world_size):
        ...
        creat_model.config.auto_map["AutoModelForCausalLM"] = 'modeling_aquila_ascend.AquilaForCausalLM'
