...
class InternLMModel(InternLMPreTrainedModel):
    ...
    def init_ascend_weight(self):
        ...
        for i in range(self.num_layers):
            ...
            weights_t.append(weights_layer["self_attn.q_proj.bias"])
            weights_t.append(weights_layer["self_attn.k_proj.weight"])
            weights_t.append(weights_layer["self_attn.k_proj.bias"])
            weights_t.append(weights_layer["self_attn.v_proj.weight"])
            weights_t.append(weights_layer["self_attn.v_proj.bias"])
            weights_t.append(weights_layer["self_attn.o_proj.weight"])
            weights_t.append(weights_layer["self_attn.o_proj.bias"])
    ...
    def forward(
        ...
        if self.model.lm_head_weight is None:
            ...
            if soc_version not in [104, 220, 221, 222, 223, 224]:
                self.model.lm_head_weight = self.lm_head.weight.data.npu_format_cast(29)
