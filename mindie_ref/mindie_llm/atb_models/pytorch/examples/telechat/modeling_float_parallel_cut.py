...
class TelechatMLP(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, residual: torch.Tensor) -> torch.Tensor:
        ...
        if self.world_size >= 2:
            torch.distributed.all_reduce(intermediate_output, op=torch.distributed.ReduceOp.SUM)
...
class TelechatModel(TelechatPreTrainedModel):
    ...
    def forward(
        ...
        #print("TELECHAT MODEL",input_ids.shape)
        ...
        #print(f"use cache in model is f{use_cache}") 
