...
- `HumanEval-X`数据集推理
    ...
    cp ${ATB_SPEED_HOME_PATH}/pytorch/examples/chatglm2/6b/patches/models/modeling_chatglm_ascend.py ${CHECKPOINT}/modeling_chatglm.py
    cd CodeGeeX2
    MODE=both bash ./scripts/run_humanevalx.sh
    ```
