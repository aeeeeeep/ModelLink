...
use_launch_kernel_with_tiling=0
...
start_cmd="MAX_SEQ_LEN=$max_seqence_length torchrun --nproc_per_node $rank_size_ --master_port 20002 main.py --task $task_name"
run_cmd="${atb_options} ${atb_async_options} ${atb_stream} ${atb_launch_kernel} ${lccl_options} ${start_cmd}"
