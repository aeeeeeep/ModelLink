...
#include "llama_family/model/decoder_model.h"
...
int64_t ModelTorch::SetParam(std::string param)
{
    ...
    } else if (modelName_ == "llama_family_decoder_model") {
        model_ = std::make_shared<atb_speed::llama_family::DecoderModel>(param);
