 ...
 */
#ifndef ATB_SPEED_PLUGIN_ACLNN_W8A16_BIAS_OPERATION_V2_H
#define ATB_SPEED_PLUGIN_ACLNN_W8A16_BIAS_OPERATION_V2_H
#include "acl_nn_operation.h"

namespace atb_speed {
namespace common {
class W8A16BiasOperation : public AclNnOperation {
public:
    explicit W8A16BiasOperation(const std::string &name);
    ~W8A16BiasOperation() override;
