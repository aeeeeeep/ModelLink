...
const int FA_ROPE_LAYER_IN_TOKENOFFSET_ID = 19;
const int FA_ROPE_LAYER_IN_SEQLEN_ID = 20;
...
int64_t FlashAttentionRopeModel::BuildGraph()
{
    ...
    for (int layerId = 0; layerId < param_.layerNum; ++layerId) {
        ...
        atb_speed::internlm_7b::FlashAttentionRopeLayerParam opParam;
        opParam.rmsNormEps = param_.rmsNormEps;
        opParam.headNum = param_.headNum;
        opParam.dk = param_.dk;
        opParam.rank = param_.rank;
        opParam.rankSize = param_.rankSize;
        atb_speed::internlm_7b::FlashAttentionRopeLayer(opParam, &op);
