...
#include "models/internlm/20b/operation/layer_embedding.h"
...
void FlashAttentionRopeModel::Param::FromString(const std::string &param)
{
    ...
    ATB_LOG(INFO) << "Internlm 20b FlashAttentionRopeModel param rmsNormEps:" << rmsNormEps << ", headNum:" << headNum
                  << ", kvHeadNum:" << kvHeadNum << ", dk:" << dk << ", layerNum:" << layerNum << ", rank:"
                  << rank << ", rankSize:" << rankSize << ", isBF16:" << isBF16;
}

FlashAttentionRopeModel::FlashAttentionRopeModel(
    const std::string &param) : Model("FlashAttentionRopeModel", param)
{
...
{
    ATB_LOG(INFO) << "Enter Internlm FlashAttentionRopeModel InferShape";
    ...
    ATB_LOG(INFO) << "Internlm FlashAttentionRopeModel InferShape Success";
    return atb::NO_ERROR;
}

int64_t FlashAttentionRopeModel::BuildGraph()
{
    ATB_LOG(INFO) << "Enter Internlm FlashAttentionRopeModel BuildGraph";
    ...
    atb_speed::internlm_20b::LayerEmbeddingParam layerEmbeddingParam;
    atb_speed::internlm_20b::LayerEmbedding(layerEmbeddingParam, &op);
    ...
    for (int layerId = 0; layerId < param_.layerNum; ++layerId) {
        ...
        if (((param_.quantModel || param_.sparseModel) && isFloatLayer) ||
            ...
            atb_speed::internlm_20b::FlashAttentionLayerParam floatModelParam;
            ...
            floatModelParam.model = "internlm20b";
            ...
            atb_speed::internlm_20b::FlashAttentionLayer(floatModelParam, &op);
            ...
            atb_speed::internlm_20b::FlashAttentionLayerParam quantModelParam;
            ...
            quantModelParam.model = "internlm20b";
            ...
            atb_speed::internlm_20b::FlashAttentionLayer(quantModelParam, &op);
            layerNode.operation.reset(op);
            layerNode.inTensors.resize(layerNode.operation->GetInputNum());
            layerNode.outTensors.resize(layerNode.operation->GetOutputNum());
            ...
            atb_speed::internlm_20b::FlashAttentionLayerParam sparseModelParam;
            ...
            sparseModelParam.model = "internlm20b";
            ...
            atb_speed::internlm_20b::FlashAttentionLayer(sparseModelParam, &op);
            layerNode.operation.reset(op);
            layerNode.inTensors.resize(layerNode.operation->GetInputNum());
            layerNode.outTensors.resize(layerNode.operation->GetOutputNum());
    ...
    ATB_LOG(INFO) << "Internlm 20b FlashAttentionRopeModel BuildGraph success";
    return atb::NO_ERROR;
}
