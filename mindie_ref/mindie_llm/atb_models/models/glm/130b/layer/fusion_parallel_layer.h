...
enum FusionParallelLayerTensorId : int {
    ...
    // for quant
    IN_ANTIQUQNT_SCALE_QKV,
    IN_ANTIQUQNT_OFFSET_QKV,
    IN_ANTIQUQNT_SCALE_OUTLINEAR,
    IN_ANTIQUQNT_OFFSET_OUTLINEAR,
    IN_ANTIQUQNT_SCALE_MLPUP,
    IN_ANTIQUQNT_OFFSET_MLPUP,
    IN_ANTIQUQNT_SCALE_MLPDOWN,
    IN_ANTIQUQNT_OFFSET_MLPDOWN,
