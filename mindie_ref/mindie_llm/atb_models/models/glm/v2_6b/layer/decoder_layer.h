 ...
 */
#ifndef ATB_SPEED_MODELS_GLM_V2_6B_DECODER_LAYER_H
#define ATB_SPEED_MODELS_GLM_V2_6B_DECODER_LAYER_H
...
enum DecoderLayerTensorIdx : uint32_t {
    ...
    IN_MLP_WEIGHT_0,                    // Pack: shape: [2 * intermediateSizePerRank, hiddenSize]
                                        // No pack: (Gate) shape: [intermediateSizePerRank, hdn]e]Size]

    IN_MLP_HOLDER_0,                    // Pack: shape: [2 * intermediateSizePerRank, hiddenSize]
