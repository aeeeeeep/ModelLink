...
atb::Status EncoderLayer(const LayerParam &param, atb::Operation **operation)
{
    ...
    opGraph.name = "llama_adapter_encoder_layer";
    ...
    CREATE_OPERATION(linearParam, &wVLinearNode.operation);
    ...
    atb_speed::llama_adapter::SelfAttentionCrossEn(selfAttentionCrossParam, &selfAttentionNode.operation);
    selfAttentionNode.inTensorIds = { INTERMIDATE_ROPEQ, INTERMIDATE_ROPEK, INTERMIDATE_V, IN_ATTENTIONMASK };
