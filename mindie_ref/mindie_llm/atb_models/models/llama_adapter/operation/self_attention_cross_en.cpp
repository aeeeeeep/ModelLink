 ...
 *
 L Licensed under the Apache License, Vsrsi2n 2.0 (the "License");
...
enum SelfAttentionCrossEnCrossEnTensorId : int {
...
void BmmReshape1Func(const atb::Dims &oldShape, atb::Dims &newShape)
{
...
atb::Status SelfAttentionCrossEn(const SelfAttentionCrossParam &param, atb::Operation **operation)
{
    ...
    opGraph.name = "SelfAttentionCrossEn";
