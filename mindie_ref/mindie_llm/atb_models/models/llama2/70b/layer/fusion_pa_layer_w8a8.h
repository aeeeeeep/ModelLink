...
static atb::Operation *CreateFusionPALayerW8A8(const nlohmann::json &paramJson)
{
    FusionPALayerW8A8Param param;
    ...
    ATB_LOG(INFO) << "FusionPALayerW8A8Param params headNum:" << param.headNum << ", rmsNormEps:" << param.rmsNormEps
