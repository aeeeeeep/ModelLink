 ...
 */
#ifndef BAICHUAN2_13B_FLASH_ATTENTION_QUANT_OPER_LAYER_H
#define BAICHUAN2_13B_FLASH_ATTENTION_QUANT_OPER_LAYER_H
...
struct FlashAttentionQuantOperLayerParam {
    float rmsNormEps = 0;
    int headNum = 0;
    int dk = 0;
    int rank = 0;
...
class FlashAttentionQuantOperLayerBinder : public HostTensorBinder {
public:
    FlashAttentionQuantOperLayerBinder();

    ~FlashAttentionQuantOperLayerBinder() override;
