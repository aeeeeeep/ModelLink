...
#include "models/baichuan2/7b/layer/paged_attention_layer.h"
...
REGISTER_MODEL(baichuan2_7b, PagedAttentionModel);
...
void PagedAttentionModel::Param::FromString(const std::string &param)
{
    ...
    ATB_LOG(INFO) << "Baichuan2_7BPAModel param rmsNormEps:" << rmsNormEps << ", headNum:" << headNum << ", dk:" << dk
...
PagedAttentionModel::PagedAttentionModel(const std::string &param) : Model("Baichuan2_7BPAModel", param)
{
...
int64_t PagedAttentionModel::BuildGraph()
{
    ...
    ATB_LOG(INFO) << "Baichuan2_7BPAModel nodeSize is " << nodeSize;
    ...
    for (int layerId = 0; layerId < param_.layerNum; ++layerId) {
        ...
        atb_speed::baichuan2_7b::PALayerParam opParam;
        ...
        atb_speed::baichuan2_7b::PALayer(opParam, &op);
...
atb::Status PagedAttentionModel::BindParamHostTensor(uint32_t nodeId)
{
    ...
    const uint32_t seqLenTensorId = 15; // atb_speed::baichuan2_7b::LayerPATensorId::IN_INPUT_LENGTHS;
