...
#include "deepseek_dense_fusion_layer_without_expert_operation.h"
#include "deepseek16B_dense/operation/deepseek_dense_multi_layer_linear.h"
#include "deepseek16B_dense/operation/deepseek_dense_moe.h"
#include "deepseek16B_dense/operation/deepseek_dense_position_embedding_1d_split_fusion_operation.h"
#include "deepseek16B_dense/operation/deepseek_dense_mlp_without_expert.h"
    ...
    const DeepseekDenseLayerFusionWithoutExpertParam &param, atb::Operation **operation)
{
    ...
    opGraph.name = "DeepseekDenseLayerParallelFusionWithoutExpert";
    ...
    mlpExpertNode.inTensorIds = {INTERMIDATE_SELFNORMOUT,
                                  IN_MLPGATEUPWEIGHT_SHARED_EXPERT,
                                  IN_MLPDOWNWEIGHT_EXPERT_SHARED_EXPERT};
    mlpExpertNode.outTensorIds = {INTERMIDATE_MOEOUT};
    ...
    moeAllReduceNode.outTensorIds = {INTERMIDATE_HIDDEN_STATE_SHARED_EXPERTS};
    ...
    moeResidualAddNode.inTensorIds = {INTERMIDATE_SELFRESIDUALADDOUT, INTERMIDATE_HIDDEN_STATE_SHARED_EXPERTS};
...
DeepseekDenseLayerFusionWithoutExpertBinder::DeepseekDenseLayerFusionWithoutExpertBinder() {}

DeepseekDenseLayerFusionWithoutExpertBinder::~DeepseekDenseLayerFusionWithoutExpertBinder() {}

void DeepseekDenseLayerFusionWithoutExpertBinder::ParseParam(const nlohmann::json &paramJson)
{
    tokenOffset_.clear();
...
void DeepseekDenseLayerFusionWithoutExpertBinder::BindTensor(atb::VariantPack &variantPack)
{
