...
enum AntiQuantLayerTensorId : int {
    IN_HIDDENSTATES = 0,
    IN_NORMWEIGHT,
    IN_BETA,
...
AntiQuantLayerBinder::AntiQuantLayerBinder() {}

AntiQuantLayerBinder::~AntiQuantLayerBinder() {}

void AntiQuantLayerBinder::ParseParam(const nlohmann::json &paramJson)
{
    tokenOffset_.clear();
...
void AntiQuantLayerBinder::BindTensor(atb::VariantPack &variantPack)
{
