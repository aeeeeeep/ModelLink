...
*  */
#include "deepseek_dense_position_embedding_1d_split_fusion_operation.h"
#include <atb/atb_infer.h>

namespace atb_speed {
namespace deepseekDense {
enum DeepseekDensePositionEmbedding1DSplitFusionTensorId {
    IN_QLAYERTENSOR = 0,
    IN_KLAYERTENSOR,
    IN_COSTABLETENSOR,
    IN_SINTABLETENSOR,
    ...
    const DeepseekDensePositionEmbedding1DSplitFusionParam &param, atb::Operation **operation)
{
    ...
    opGraph.name = "DeepseekDenseROPEfusion";
