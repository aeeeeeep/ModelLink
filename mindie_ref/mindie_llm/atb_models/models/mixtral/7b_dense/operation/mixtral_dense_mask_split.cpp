...
*  */
#include "mixtral_dense_mask_split.h"
#include <atb/atb_infer.h>
#include "atb_speed/log.h"

namespace atb_speed {
namespace mixtralDense {
enum MixtralDenseMaskSplitTensorId {
    IN_INPUT_MASK = 0,
...
atb::Status CreateMixtralDenseMaskSplitOperation(const MixtralDenseMaskSplitParam &param, atb::Operation **operation)
{
    std::shared_ptr<int64_t> batchDimPtr = std::make_shared<int64_t>(0);

    atb::GraphParam opGraph;
    opGraph.name = "MixtralDenseMaskSplit";
