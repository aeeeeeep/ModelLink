...
{
    ATB_LOG(INFO) << __func__ << " called, headNum: " << param.headNum << ", dk:" << param.dk
    ...
    ropeNode.inTensorReshapeFuncs = {&mergeBatchSeqAndHeadFunc, &mergeBatchSeqAndHeadFunc,
                                     &mergeBatchSeqForSinCosFunc, &mergeBatchSeqForSinCosFunc};
