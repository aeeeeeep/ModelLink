...
atb::Status FlashAttentionKvCacheRopeLayer(const FlashAttentionKvCacheRopeParam &param, atb::Operation **operation)
{
    ...
    opGraph.name = "FlashAttentionKvCacheRopeLayer";
    ...
    atb::Node &positionEmbeddingFusionNode = opGraph.nodes.at(nodeId++);
    ...
    atb_speed::gptneox_20b::PositionEmbeddingFusionParam positionEmbeddingFusionParam;
    positionEmbeddingFusionParam.headNum = param.headNum;
    positionEmbeddingFusionParam.dk = param.dk;
    positionEmbeddingFusionParam.rotaryPct = param.rotaryPct;
    atb_speed::gptneox_20b::PositionEmbeddingFusionOperation(positionEmbeddingFusionParam,
        &positionEmbeddingFusionNode.operation);
    positionEmbeddingFusionNode.inTensorIds = { INTERMEDIATE_MIXEDQKVLINEAROUT, IN_COSEMBED, IN_SINEMBED, IN_SEQLEN };
...
void FlashAttentionRopeHostBinder::BindTensor(atb::VariantPack &variantPack)
{
