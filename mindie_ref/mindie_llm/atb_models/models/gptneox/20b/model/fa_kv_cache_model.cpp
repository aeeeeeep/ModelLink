 ...
 */
#include "models/gptneox/20b/model/fa_kvcache_model.h"
...
void FaKvCacheModel::Param::FromString(const std::string &param)
{
...
int64_t FaKvCacheModel::BuildGraph()
{
    ...
    for (int layerId = 0; layerId < param_.layerNum; ++layerId) {
        ...
        atb_speed::gptneox_20b::LayerParam opParam;
...
atb::Status FaKvCacheModel::ParseParam(const std::string &param)
{
    nlohmann::json paramJson = nlohmann::json::parse(param);
    tokenOffset_.clear();
