...
uint32_t FaKvCacheRopeModel::GetInputNum() const { return graph_.inTensors.size(); }

uint32_t FaKvCacheRopeModel::GetOutputNum() const { return graph_.outTensors.size(); }
