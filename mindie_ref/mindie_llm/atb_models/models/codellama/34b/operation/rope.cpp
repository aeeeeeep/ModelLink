...
static const uint64_t OUT_TENSOR_EMBED_K_SHAPE = 4;
...
atb::Status Rope(const RopeParam &param, atb::Operation **operation)
{
    ...
    opGraph.inferShapeFunc = [=](const atb::SVector<atb::TensorDesc> &inTensorDescs,
        ...
        size_t outTensorEmbedKThirdDim = 3;
        ...
        outTensorDescs.at(OUT_TENSOR_EMBED_K_ID) = inTensorDescs.at(ROPE_IN_MIXED_K_ID);
        outTensorDescs.at(OUT_TENSOR_EMBED_K_ID).shape.dimNum = OUT_TENSOR_EMBED_K_SHAPE;
        outTensorDescs.at(OUT_TENSOR_EMBED_K_ID).shape.dims[firstDim] =
            inTensorDescs.at(ROPE_IN_MIXED_K_ID).shape.dims[firstDim];
        outTensorDescs.at(OUT_TENSOR_EMBED_K_ID).shape.dims[secondDim] =
            inTensorDescs.at(ROPE_IN_MIXED_K_ID).shape.dims[secondDim];
        outTensorDescs.at(OUT_TENSOR_EMBED_K_ID).shape.dims[headNumDim] = param.kvHeadNum;
        outTensorDescs.at(OUT_TENSOR_EMBED_K_ID).shape.dims[outTensorEmbedKThirdDim] =
            inTensorDescs.at(ROPE_IN_MIXED_K_ID).shape.dims[headNumDim] / param.kvHeadNum;
