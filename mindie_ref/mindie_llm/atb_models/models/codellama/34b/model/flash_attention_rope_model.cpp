 ...
 */
#include "models/codellama/34b/model/flash_attention_rope_model.h"
...
int64_t FlashAttentionRopeModel::BuildGraph()
{
    ...
    for (int layerId = 0; layerId < param_.layerNum; ++layerId) {
        ...
        atb_speed::codellama_34b::FlashAttentionRopeLayerParam opParam;
        ...
        atb_speed::codellama_34b::FlashAttentionRopeLayer(opParam, &op);
