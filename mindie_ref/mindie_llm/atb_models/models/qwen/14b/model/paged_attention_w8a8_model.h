 ...
 */
#ifndef ATB_SPEED_MODELS_QWEN_14B_PA_W8A8_MODEL_H
#define ATB_SPEED_MODELS_QWEN_14B_PA_W8A8_MODEL_H
...
namespace atb_speed {
namespace qwen_14b {
class PAW8A8Model : public Model {
public:
    struct Param {
    ...
    explicit PAW8A8Model(const std::string &param);
    ~PAW8A8Model();
...
REGISTER_MODEL(qwen_14b, PAW8A8Model);
