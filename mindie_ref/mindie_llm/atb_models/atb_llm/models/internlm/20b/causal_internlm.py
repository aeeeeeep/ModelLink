...
from .modeling_Internlm import InternlmModel, InternlmConfig
from ...utils.data.weight_wrapper import AttnModuleNames, MlpModuleNames, WeightWrapper


class InternlmForCausalLM(CausalLM):
    ...
    def init_ascend_operations(self, config: InternlmConfig):
        # 初始化模型
        self.acl_encoder_operation = torch.classes.ModelTorch.ModelTorch("Internlm_parallel_20b_DecoderModel")
        self.acl_decoder_operation = torch.classes.ModelTorch.ModelTorch("Internlm_parallel_20b_DecoderModel")
