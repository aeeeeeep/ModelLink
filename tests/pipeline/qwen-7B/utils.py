...
class ParamConfig:
    ...
    # evaluation
    evaluation_param_mmlu = config_file["EVALUATION_PARAM_MMLU"]
    evaluation_param_boolq = config_file["EVALUATION_PARAM_BOOLQ"]
    evaluation_param_ceval = config_file["EVALUATION_PARAM_CEVAL"]
