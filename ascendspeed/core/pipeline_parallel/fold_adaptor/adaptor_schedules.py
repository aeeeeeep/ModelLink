...
from . import adaptor_p2p_comm as p2p_communication
# Types
...
ascendspeed.core.pipeline_parallel.schedules.forward_step = forward_step
ascendspeed.core.pipeline_parallel.schedules.backward_step = backward_step
ascendspeed.core.pipeline_parallel.schedules.get_forward_backward_func = get_forward_backward_func
