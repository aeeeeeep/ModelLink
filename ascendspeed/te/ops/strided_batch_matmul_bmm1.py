...
class StridedBatchMatmulBmm1Function(torch.autograd.Function):
    @staticmethod
    def forward(ctx, a, b, seqlen, head_num):
        ...
        c = ascendspeed_te_ops.npu_strided_batch_matmul(a, b, transA, transB, m, k, n, lda, ldb, ldc, strideA, strideB, strideC, batch, head_num)
    ...
    def backward(ctx, grad_out):
        ...
        grad_x = ascendspeed_te_ops.npu_strided_batch_matmul(grad_out, y, transA, transB, m, k, n, lda, ldb, ldc, strideA, strideB, strideC, batch, head_num).view(x.shape[0], x.shape[1])
        ...
        grad_y_tmp = ascendspeed_te_ops.npu_strided_batch_matmul(x, grad_out, transA, transB, m, k, n, lda, ldb, ldc, strideA, strideB, strideC, batch, head_num)
...
class StridedBatchMatmulBmm1(Module):
    def __init__(self, head_num):
        super(StridedBatchMatmulBmm1, self).__init__()
        self.head_num = head_num

    def forward(self, a, b, seqlen):
        return StridedBatchMatmulBmm1Function.apply(a, b, seqlen, self.head_num)
