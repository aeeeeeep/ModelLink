...
def pad_batch(batch, args):
    ...
    fused_operator_contiguous_num = 32
    max_length = math.ceil(max_length / fused_operator_contiguous_num) * fused_operator_contiguous_num
...
def _sample_and_synchronize(args, batch_size, context_length_info, logits, tokens):
    ...
    return group, log_probs, prev, src, started, vocab_size
