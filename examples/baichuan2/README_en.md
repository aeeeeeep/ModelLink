...
python tools/checkpoint/util.py --model-type GPT \
    ...
    --w-pack True \
    --save-dir ./model_from_hf/Baichuan2-7B-Base/   # <-- Fill in the original HF model path here, new weights will be saved in ./model_from_hf/Baichuan2-7B-Base/mg2hg
```
...
python tools/checkpoint/util.py --model-type GPT \
    ...
    --target-pipeline-parallel-size 1 \
    --w-pack True \
    --save-dir ./model_from_hf/Baichuan2-13B-Base/   # <-- Fill in the original HF model path here, new weights will be saved in ./model_from_hf/Baichuan2-13B-Base/mg2hg
```
