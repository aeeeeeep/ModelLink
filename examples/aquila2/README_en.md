...
4. Prepare dataset.
    ...
    step2: use Aquila2-7B specified tokenizer to pre-process data:
...
6. Config Aquila2-7B pre-training script.
    ...
    TOKENIZER_PATH="./model_from_hf/Aquila2-7B/"  #tokenizer path
    DATA_PATH="./dataset/Aquila2-7B/alpaca_text_document"  #processed dataset
    CKPT_LOAD_DIR="./model_weights/Aquila2-7B-v0.1-tp8-pp1/"   # pointing to the converted model weights
    CKPT_SAVE_DIR="./ckpt/Aquila2-7B/"                   # pointing to the path to save checkpoints
    ```
...
7. Launch Aquila2-7B pre-training script.
    ...
    Start pre-training Aquila2-7B model:
...
| --------- | ------------- | --------- | ---------- | ---------------------------- | ----------------------------------- |
| NPU       | 910b 1node*8p | Aquila2-7B | 1000       | 2890                         | 5.67                                |
| Reference |               | Aquila2-7B | 1000       | 2717                         | 6.03                               |
...
| ---------------------------------------------------------------------- | --------- | ----- | --------- |
| [BoolQ](https://github.com/google-research-datasets/boolean-questions) | Aquila2-7B | 77.1% |  77.6%   |
