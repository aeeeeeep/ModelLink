...
python ./tools/preprocess_data.py \
    ...
    --output-prefix ./dataset/Baichuan-7B \
    --workers 4 \
    --log-interval 1000 \
...
CKPT_SAVE_DIR="../../ckpt/"
DATA_PATH="./dataset/baichuan-7B_text_document"
...
python tools/checkpoint/util.py \
    ...
    --save-dir ./model_weights/Baichuan-13B-Base-v0.1-pt8-pp1/ \
...
python tools/checkpoint/util.py --model-type GPT \
    ...
    --saver megatron \
    --save-model-type save_huggingface_llama \
    --load-dir ./model_weights/Baichuan-13B-Base-v0.1-pt8-pp1/ \
    --target-tensor-parallel-size 1 \
    --target-pipeline-parallel-size 1 \
    --w-pack True \
...
python ./tools/preprocess_data.py \
    ...
    --output-prefix ./dataset/Baichuan-13B \
    --workers 4 \
    --log-interval 1000 \
    --tokenizer-type PretrainedFromHF 
```
...
CKPT_SAVE_DIR="../../ckpt/"
DATA_PATH="./dataset/Baichuan-13B_text_document"
TOKENIZER_MODEL="./model_from_hf/Baichuan-13B/tokenizer.model"
CKPT_LOAD_DIR="./model_weights/Baichuan-13B-Base-v0.1-pt8-pp1/" 
```
...
# 修改模型权重路径和词表路径
CHECKPOINT="../../model_weights/Baichuan-13B-Base-v0.1-pt8-pp1/"
