...
5. 微调
	5.1 准备微调数据集
	下载微调数据集 [here](https://huggingface.co/datasets/tatsu-lab/alpaca/resolve/main/data/train-00000-of-00001-a09b74b3ef9c3b56.parquet)    
    ```shell
   # 下载数据集
...
```
启动llama2-7b推理脚本: examples/llama2/generate_llama2_7b_ptd.sh
```bash
...
## 评估-7B
使用 MMLU数据集评估模型. 数据集下载路径 [here](https://huggingface.co/datasets/cais/mmlu). 评估脚本如下所示:
