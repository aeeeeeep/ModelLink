...
DATA_PATH="./finetune_dataset/llama-33b-hf_text_document"  #processed dataset
LORA_CHECKPOINT="your lora weight"
LOAD_CHECKPOINT_PATH="./model_weights/llama-33b-hf-v0.1-tp8-pp1"
SAVE_CHECKPOINT_PATH="./ckpt/"
```
...
DATA_PATH="./finetune_dataset/llama-65b-hf_text_document"  #processed dataset
LORA_CHECKPOINT="your lora weight"
