...
python tools/checkpoint/util.py \
    ...
    --save-dir ./model_weights/internlm-7b-v0.1-pt8-pp1/ \
...
python tools/checkpoint/util.py --model-type GPT \
    ...
    --load-dir ./model_weights/internlm-7b-v0.1-pt8-pp1/ \
...
python ./tools/preprocess_data.py \
    ...
    --output-prefix ./dataset/internlm-7b \
    --workers 4 \
    --log-interval 1000  \
...
# 修改数据集，词表，权重等路径
CKPT_SAVE_DIR="../../ckpt/"
CKPT_LOAD_DIR="./model_weights/internlm-7b-v0.1-pt8-pp1/"
TOKENIZER_PATH="./model_from_hf/internlm-7b/tokenizer.model"#词表路径
DATA_PATH="./dataset/internlm-7b_text_document" #数据集路径
```
